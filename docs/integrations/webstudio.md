---
title: Deploy Webstudio Projects to Hetzner with Arvialo
---

# Deploy Webstudio Projects using Arvialo
Arvialo makes deploying your Webstudio projects to Hetzner as simple as it is powerful. 
...
- A [GitHub account ↗](https://github.com?utm_source=arvialo.io) to host your code.
- A [Hetzner account ↗](https://arvialo.io/hetzner) to provision your server (or an account with any other hosting provider).
- The [Webstudio CLI ↗](https://docs.webstudio.is/university/self-hosting/cli?utm_source=arvialo.io) installed locally to manage your project exports.
...
This prepares your project for deployment via Arvialo without the need for additional dependency installations.
...
Skip to [Step 6 ↗](#_6-configure-your-project-on-arvialo) if your server is already connected to Arvialo.
:::
...
## 5. Connect Arvialo to Your Server

::: warning HEADS UP!
If your server is already connected to Arvialo, skip to the [next step ↗](#_6-configure-your-project-on-arvialo).
:::
...
## 6. Configure Your Project on Arvialo
...
5. **Configure Domains & Deploy:** Enter your domain in the domains field and Click **Deploy** and wait as Arvialo builds and deploys your project. 
...
2. **Sync and Build:** Run the following commands in your terminal:
   ...
   ```
3. **Push Updates:** Commit and push your changes to GitHub. Arvialo will detect the update and automatically trigger a new deployment.
