...
const referralUrl = frontmatter.value.referral?.url ?? 'https://arvialo'
const referralText = frontmatter.value.referral?.text ?? "If you don't have a server or server provider yet."
const referralDescription = frontmatter.value.referral?.description ?? "Copy and visit the above url to get a present at Arvialo!"
