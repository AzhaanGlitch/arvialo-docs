...
Scheduled database backups could be configured for PostgreSQL and for Arvialo itself.
...
Arvialo creates a full backup of your PostgreSQL databases. You can specify which database to backup, with a comma separated list.

::: info Tip
Arvialo own database is also backed up using this method.
:::
